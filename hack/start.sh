...
# 主机配置目录
HOST_ETC_DIR="/opt/my-api-server"
HOST_CONFIG_FILE="${HOST_ETC_DIR}/etc/config.yaml"

# 容器路径
CONTAINER_CONFIG_PATH="/app/my-api-server/etc/config.yaml"
...
show_help() {
    ...
    echo
    echo "配置挂载:"
    echo "  ${HOST_CONFIG_FILE}  →  /app/my-api-server/etc/config.yaml"
